              ...
              <tr>
                <td class="content-cell">
                  <div class="f-fallback">
                    ...
                    <p>Votre facture {{$invoice->code}} a été payée. Vous pouvez desormais avoir acces aux services facturés.</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                              <td align="center">
                                <a href="{{ config('app.front_app_url') }}" class="f-fallback button button--green" target="_blank">Accéder aux services</a>
                              </td>
                            </tr>
                          </table>
                        </td>

              ...
              <tr>
                <td class="content-cell">
                  <div class="f-fallback">
                    ...
                    <p>Merci d'utiliser {{ config('app.name') }}. Voici la facture de votre dernier achat sur {{ config('app.name') }}.</p>
                            ...
                            <tr>
                              <td class="attributes_item">
                                <span class="f-fallback">
                                  <strong>Montant :</strong> ${{$invoice->getInvoiceTotalAmount()}}
                                </span>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td align="center">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                              <td align="center">
                                <a href="{{ config('app.front_app_url') }}" class="f-fallback button button--green" target="_blank">Payer la facture</a>
                              </td>
                            </tr>
                          </table>
                        </td>

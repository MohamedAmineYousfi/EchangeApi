...
class RunDryProductSynchronizeController extends JsonApiController
{
    public function drySynchronize(Import $import, RunProductSynchronizeRequest $request): Response
    {
        /** @var User */
        $user = Auth::user();
        if (! (

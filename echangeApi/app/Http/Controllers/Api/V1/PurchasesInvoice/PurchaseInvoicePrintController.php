...
class PurchaseInvoicePrintController extends JsonApiController
{
    /**
    ...
    public function sendMail(MailSendFormRequest $request, PurchasesInvoice $order)
    {
        ...
        $response = DocumentsMailSender::sendMailWithAttachment('pdf.purchasesInvoice.print',
            [
                'filename' => $filename,
                'order' => $order,
            ],

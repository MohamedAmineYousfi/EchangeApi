...
use App\Rules\SalesInvoiceOrderItem;
...
class Validators extends AbstractValidators
{
    ...
    protected function rules($record, array $data): array
    {
        return [
            ...
            'quantity' => ['required', 'integer', 'min:1', new SalesInvoiceOrderItem()],
            ...
            'salesInvoiceable' => [
                ...
                new UniqueLineItemOf(SalesInvoice::class, 'salesInvoice', 'salesInvoiceable'),
            ],
            'taxGroups' => [

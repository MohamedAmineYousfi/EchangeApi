...
class TaxPolicy
{
     ...
     */
    public function view(User $user, Tax $category): bool
    {
     ...
     */
    public function update(User $user, Tax $category): bool
    {
     ...
     */
    public function delete(User $user, Tax $category): bool
    {
     ...
     * @return void
     */
    public function restore(User $user, Tax $category)
    {
        //
    }
     ...
     * @return void
     */
    public function forceDelete(User $user, Tax $category)
    {
        //
    }
}
